...
public class IUserServiceImpl implements IUserService{
    ...
    public User insertUser(UserCredentialsDTO userCredentialsDTO) throws EntityAlreadyExistsException {
        ...
        try {
            ...
            //Checking for existence of the specific combination of username and password
            //in order to allow two users to have the same username but different passwords.
            List<User> existingUsers = userDAO.getByUsername(user.getUsername());
            ...
            //Checking for pre-existence of designated ID
